 ...
 **Esse fork foi criado para voltar a compatibilidade com o JDK 1.8, ao qual foi descolado no Repositório principal do projeto.** 
...
### Diretamente pelo código fonte (última versão em desenvolvimento)
 ```console
    git clone https://github.com/dennnisk/nfe-jdk-1.8
    mvn clean install
  ```
